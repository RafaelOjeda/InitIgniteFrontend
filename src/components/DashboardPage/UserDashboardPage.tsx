...
import SchoolGeneralInfo from "./DashboardPageComponents/SchoolGeneralInfo.tsx";
import TeacherStudentSchedule from "./DashboardPageComponents/TeacherStudentSchedule.tsx";
