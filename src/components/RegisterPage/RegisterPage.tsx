	...
	return (
		...
		<form onSubmit={handleRegister}>
			...
			>
				...
				<button className="btn btn-success" type="submit" style={{ marginTop: '0.5rem', width: '275px' }}>
					Create Account
				</button>
				<button className="btn btn-secondary" type="button" onClick={() => navigate('/login')} style={{ marginTop: '1rem', marginBottom: '1rem', width: '275px' }} >
					Return to Login
				</button>
			  </Box>
			</Box>
